...
def gerar_site_vendas_completo():
    ...
    <div id="modalCheckout" class="modal">
        <div class="modal-content" style="text-align: left;">
            ...
            <div class="form-group"><input type="text" id="f_cpf" class="input-style" placeholder="CPF"></div>
    ...
    <script>
        ...
        function enviarPedido() {{
            ...
            const dados = {{
                ...
                cpf: document.getElementById('f_cpf').value.trim().toUpperCase(),
            ...
            if(!dados.n || !dados.cpf || !dados.e || !dados.nu || !dados.ba || !dados.ci || !dados.es || !dados.t) {{
