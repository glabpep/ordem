...
def gerar_site_vendas_completo():
    ...
    <head>
        ...
        <style>
            ...
            .brinde-tag {{ color: #00ff00; font-weight: bold; font-size: 0.75rem; display: block; }}
        </style>
    </head>
    <body>
    ...
    <script>
        ...
        function aplicarCupom() {{
            ...
            const cupons = {{
                ...
                'LUD5': 0.05, 'CASSIA5': 0.05, 'THAIS5': 0.05, 'NATAN': 0.00001,
            }};
            if(cupons[code]) {{
        ...
        function enviarPedido() {{
            ...
            // INCLUSÃO DO BRINDE NA MENSAGEM DO WHATSAPP
            if (temBrinde) {{
    ...
    try:
        ...
        print(f"🚀 Regra do Cupom Bruna5 integrada (Brinde Bacteriostatic 7ml).")
    except Exception as e:
