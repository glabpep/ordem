...
function aplicarCupom() {{
  ...
  const cupons = {{'BRUNA5':0.05,'DANI5':0.05,'GILMARA5':0.05,'DAFNE10':0.10,'NOS5':0.05,'ROGERIO5':0.05,
    ...
    'WEY5':0.05,'ALE5':0.05,'TRIGUEIRO':0.05,'RAYSSA5':0.05,'BRUNA11':0.11, 'PATRICIA5':0.05}};
