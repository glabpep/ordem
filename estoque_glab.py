...
def gerar_site_vendas_completo():
    ...
    infos_tecnicas = {
        "5-AMINO": {"desc": "Inibidor Seletivo de NNMT: Atua bloqueando a enzima nicotinamida N-metiltransferase, o que eleva os níveis de NAD+ e SAM intracelular. Indica eficácia na reversão da obesidade e otimização do gasto energético basal.", "cat": "Metabolismo", "icon": "🔥"},
        "AICAR": {"desc": "Ativador de AMPK: Mimetiza o AMP intracelular para ativar a proteína quinase. Investigado por aumentar a captação de glicose muscular, a oxidação de ácidos graxos e a resistência cardiovascular.", "cat": "Metabolismo", "icon": "🔥"},
        ...
        "L-CARNITINE": {"desc": "Cofator de Transporte Mitocondrial: Essencial para o transporte de ácidos graxos para a matriz mitocondrial (β-oxidação). Reduz a fadiga muscular e suporta a performance atlética.", "cat": "Metabolismo", "icon": "🔥"},
        ...
        "LIPO C": {"desc": "Mix Lipotrópico Injetável: Composto por Metionina, Inositol e Colina. Atua na exportação de gorduras do fígado e na otimização da mobilização lipídica sistêmica.", "cat": "Metabolismo", "icon": "🔥"},
        ...
        "GHRP-6": {"desc": "Peptídeo Liberador de GH: Estimula a hipófise e aumenta a sinalização da fome via grelina. Focado em recuperação de tecidos, aumento de massa bruta e estados catabólicos.", "cat": "Hormônios", "icon": "💉"},
        "HEXARELIN": {"desc": "Potencializador de Força: Secretagogo potente da classe GHRP. Aumenta a força contrátil cardíaca e muscular, protegendo o miocárdio e promovendo volume fibroso.", "cat": "Hormônios", "icon": "💉"},
        ...
        "IGF DES": {"desc": "Variante de IGF-1 de Ação Local: Afinidade 10x maior pelos receptores. Ideal para aplicação pós-treino visando recuperação imediata e crescimento muscular localizado.", "cat": "Hormônios", "icon": "💉"},
        ...
        "MK-677": {"desc": "Secretagogo Oral (Ibutamoren): Agonista dos receptores de grelina. Aumenta sustentadamente os níveis de GH e IGF-1, aumentando a massa livre de gordura e densidade óssea.", "cat": "Hormônios", "icon": "💉"},
        ...
        "BPC-157 ORAL": {"desc": "Modulador Gastrointestinal: Versão estável em suco gástrico. Focado no tratamento de Doença de Crohn, SII, úlceras e restauração da barreira intestinal.", "cat": "Recuperação", "icon": "🩹"},
        ...
        "LL-37": {"desc": "Peptídeo Antimicrobiano: Parte do sistema imune inato. Neutraliza endotoxinas bacterianas, modula a resposta inflamatória e acelera cicatrização de feridas infectadas.", "cat": "Imunidade", "icon": "🛡️"},
        ...
        "METHYLENE BLUE": {"desc": "Otimizador Mitocondrial (Azul de Metileno): Transportador alternativo de elétrons. Melhora a memória de curto prazo e protege contra neurodegeneração.", "cat": "Cognitivo", "icon": "🧠"},
        ...
        "KISSPEPTIN": {"desc": "Regulador de Eixo HPG: Atua no hipotálamo para restaurar a produção natural de testosterona e regular a função reprodutiva de forma fisiológica.", "cat": "Hormônios", "icon": "💉"},
        "MELANOTAN 1": {"desc": "Agonista de Melanocortina Seletivo: Estimula a liberação de melanina com alta segurança e proteção contra danos UV.", "cat": "Estética", "icon": "✨"},
        "MELANOTAN 2": {"desc": "Bronzeamento e Libido: Atua no SNC aumentando a pigmentação da pele, elevando o desejo sexual e reduzindo o apetite.", "cat": "Estética", "icon": "✨"},
        ...
        "VITAMIN B-12": {"desc": "Metilcobalamina de Alta Potência: Essencial para a bainha de mielina, produção de glóbulos vermelhos e prevenção da fadiga neuromuscular.", "cat": "Suplemento", "icon": "💊"},
        ...
        "HYALURONIC ACID 2% + GHK": {"desc": "Arquitetura Extracelular: Une hidratação profunda (HA) com sinalização regenerativa (GHK).", "cat": "Estética", "icon": "✨"},
        "HCG": {"desc": "Mimetizador de LH: Sinaliza aos testículos a produção de testosterona. Vital para prevenir atrofia testicular e reinício do eixo hormonal (TPC).", "cat": "Hormônios", "icon": "💉"},
        "HEMP OIL": {"desc": "Suporte Fitocanabinoide: Propriedades analgésicas e anti-inflamatórias. Suporta o sistema endocanabinoide.", "cat": "Suplemento", "icon": "💊"},
...
function atualizarCarrinho() {{
  ...
  sc.style.display = freteD ? 'flex' : 'none';
  if (freteD) document.getElementById('ship-info-text').textContent = '🚚 ' + freteD;
...
async function calcularFrete() {{
  ...
  if      (REGIOES.SUL.includes(uf))                                          {{ freteV = 0;  freteD = "SUL R$ 0,00 (3-9 dias)"; }}
  else if ([...REGIOES.SUDESTE, ...REGIOES['CENTRO-OESTE']].includes(uf))     {{ freteV = 0; freteD = "SUDESTE/CO R$ 0,00 (5-15 dias)"; }}
  else                                                                         {{ freteV = 0; freteD = "N/NE R$ 0,00 (10-30 dias)"; }}
...
function abrirCheckout() {{
  if (!document.getElementById('f_cidade').value) {{ alert("Calcule o frete primeiro!"); return; }}
