...
def gerar_site_vendas_completo():
    ...
    <div class="container">
        ...
        <div class="lote-alert-card">
            📢 Previsão de chegada de novos itens 16/03/2026, o estoque do site será atualizado!
        </div>
    ...
    <script>
        ...
        function aplicarCupom() {{
            ...
            const cupons = {{
                ...
                'ANDREAFLEURY': 0.05, 'BRUNA10': 0.10, 'ANA5': 0.05, '10PRO': 0.000000000001, 'PRO5': 0.05, 
                'WEY5': 0.05, 
            }};
            if(cupons[code]) {{
